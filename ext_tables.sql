...
CREATE TABLE pages (
	...
	tx_adxwebmastertools_google_analytics_anonymize_ip tinyint(4) DEFAULT '0' NOT NULL,
	tx_adxwebmastertools_google_analytics_allow_linker tinyint(4) DEFAULT '0' NOT NULL,
	tx_adxwebmastertools_google_analytics_allow_hash tinyint(4) DEFAULT '0' NOT NULL,
	tx_adxwebmastertools_google_analytics_local_remote_server_mode tinyint(4) DEFAULT '0' NOT NULL,
	tx_adxwebmastertools_xml_sitemap_disable tinyint(4) DEFAULT '0' NOT NULL,
